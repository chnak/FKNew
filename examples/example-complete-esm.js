/**
 * ESM 完整示例 - 展示所有元素类型的使用
 * 运行方式: node examples/example-complete-esm.js
 */
...
async function completeExample() {
  ...
  // ========== 导出视频 ==========
  const outputPath = path.join(outputDir, 'example-complete-esm.mp4');
